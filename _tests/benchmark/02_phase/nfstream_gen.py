...
CSV_OUTPUT_PATH = "csv/nfstream_flows_eth2dump-pingFloodDDoS-30m-12h_1.csv"
...
# Ici on pourrait filtrer les flux si besoin
filtered_flows = streamer
    ...
    for flow in filtered_flows:
        writer.writerow(
            [
                ...
                timestamp_to_str(flow.bidirectional_first_seen_ms),
                timestamp_to_str(flow.bidirectional_last_seen_ms),
